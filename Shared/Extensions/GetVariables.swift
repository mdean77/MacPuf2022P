...
extension Human {
    mutating func setVariables(){
        ...
        var TC2MT = 13.38                           // TC2MT Factor 16
        ...
        var TND = -10.0                             // TND Factor 77 0.0851 ??  Minutes that brain has been deprived of O2 MARK: 0.0851  was in new version
        var RC2CT = 47.35                           // MacPuf variable RC2CT  Factor 78
        var QB = 33.29                              // QB Factor 79   Net CO2 output per unit time interval MARK: 199.5492 in old version
        ...
        var QA = 41.61                              // QA Factor 113 O2 uptake per unit time interval
