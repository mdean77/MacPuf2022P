...
//    func oxygenContent(pO2:Double, pCO2:Double, pH:Double,
//                       temperature:Double = 37.0, DPG:Double = 3.7843,
//                       Hct:Double = 45.0, Hgb:Double = 14.8) -> Double {
//        
//        let sat = saturation(pO2:pO2, pCO2:pCO2, pH:pH,
//                             temperature:temperature, DPG:DPG,
//                             Hgb: Hgb)
//        
...
//    }
//    
//    func saturation(pO2:Double, pCO2:Double, pH:Double,
//                    temperature:Double = 37.0, DPG:Double = 3.7843,
//                    Hgb:Double = 14.8) -> Double {
//        // Series of constants needed for the Kelman equations
//        let a1 = -8.532229E3
//        let a2 = 2.121401E3
//        let a3 = -6.707399E1
...
//    }
//    
//    func co2Content(pO2:Double, pCO2:Double, pH:Double,
//                    temperature:Double = 37.0, DPG:Double = 3.7843,
//                    Hct:Double = 45.0, Hgb:Double = 14.8) -> Double {
//        let sat = saturation(pO2:pO2, pCO2:pCO2, pH:pH,
//                             temperature:temperature, DPG:DPG,
...
//        let cp = sol * pCO2 * (1 + pow(10, pH - pk))
//        let cc = (dox + (dr - dox) * (1 - sat)) * cp
//        var co2Content = (cc * (Hct) + (1 - (Hct)) * cp) * 2.22
//        return  co2Content
// 
//    }
}
