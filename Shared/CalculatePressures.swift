...
//    repeat {
//        //
//        //          REVISED FUNCTION STRUCTURE JUNE 2022
//        //            trial.pO2 = pO2
//        //            trial.pCO2 = pCO2
//        //            trial = calculateTrialContents(trialGases: trial)
//        //            trialO2Content = trial.contO2
//        //            trialCO2Content = trial.contCO2
//        trialO2Content = calculateContents(pO2: pO2, pCO2: pCO2, pH: pH, temperature: temperature, DPG: DPG, Hct: Hct, Hgb: Hgb).oxygenContent
//        trialCO2Content = calculateContents(pO2: pO2, pCO2: pCO2, pH: pH, temperature: temperature, DPG: DPG, Hct: Hct, Hgb: Hgb).carbonDioxideContent
