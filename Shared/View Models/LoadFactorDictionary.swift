...
extension Simulator {
    ...
    func loadFactorDictionary(){
        ...
        factors[2] = Factor(title: "Inspired CO2 (%)", reference: 0.0, current: human.FIC2,format: "%.2f", lower:0, upper:100)
        ...
        factors[16] = Factor(title: "Tissue CO2 stores, liters STPD",reference: 13.37, current: human.TC2MT,format: "%.2f", lower:5, upper:50)
        ...
        factors[22] = Factor(title: "Brain bicarb (+/-) from normal, mmol/l", reference: -0.0678, current: human.BC3AJ,format: "%.3f", lower:-15, upper:20)
        ...
        factors[25] = Factor(title: "Index of state of fitness", reference: 28, current: human.FITNS,format: "%.0f", lower:27, upper:43)
